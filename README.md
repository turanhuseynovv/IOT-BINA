...
* **Ekran Görüntüsü:**
  ![Ana Panel](./images/ana-panel.png)
...
* **Ekran Görüntüsü:**
  ![Ziyaretçi Takibi](./images/ziyaretci-takibi.png)

### 3. 🌡️ Sensör Verileri (IoT Entegrasyonu)
Raspberry Pi 3B+ merkezi sunucusuna bağlı ESP32 düğümlerinden gelen verilerin izlenmesi.
* Kat ve oda bazlı sıcaklık ve nem takibi (Min, Ort, Max değerler).
* Anlık gaz algılama durumu ve toplam uyarı sayıları.
* **Ekran Görüntüsü:**
  ![Sensör Verileri](./images/sensor-verileri.png)

### 4. ⚠️ Şüpheli Şahıs Tespiti
Yüz tanıma eşleşmesi bulunmayan veya kara listede olan kişilerin anlık tespiti.
* Şüpheli şahıs logları ve yakalanan anlık kamera görüntüleri.
* Tehlike/işaret seviyesine göre sınıflandırma.
* **Ekran Görüntüsü:**
  ![Şüpheli Şahıs](./images/supheli-sahis.png)
...
* **Ekran Görüntüsü:**
  ![Karşılaştırmalı Analiz](./images/karsilastirmali-analiz.png)
...
* **Ekran Görüntüsü:**
  ![Tahmin Motoru](./images/tahmin-motoru.png)
...
* **Ekran Görüntüsü:**
  ![Bina Asistanı](./images/bina-asistani.png)
...
* **Frontend:** *(Kullandığın frontend teknolojisini buraya yazabilirsin, örn: React.js, Vue.js, TailwindCSS)*
...
1. Repoyu bilgisayarınıza klonlayın:
   ```bash
   git clone [https://github.com/KULLANICI_ADIN/iot-takip-sistemi.git](https://github.com/KULLANICI_ADIN/iot-takip-sistemi.git)
